...
function openPanel() {
  ...
  panel.innerHTML = `
    <div class="modal-content">
      ...
      <div style="margin-bottom: 0.1rem; padding: 0.5rem; border: 1px solid var(--color-neutral-divider); border-radius: 0.5rem; background: var(--background-card);">
        <div style="font-size: 0.8rem; color: var(--color-interaction-accent); margin-bottom: 0.2rem;">本地缓存后端地址（localStorage）</div>
        ...
        <div style="font-size: 0.8rem; color: var(--color-interaction-accent); margin-top: 0.5rem; margin-bottom: 0.2rem;">当前生效 API 地址</div>
        <div style="font-family: ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, monospace; word-break: break-all;">${apiBaseUrl}</div>
        <div style="font-size: 0.75rem; color: var(--color-interaction-accent); margin-top: 0.35rem;">来源：${sourceLabel}</div>
      </div>


      <p style="margin-bottom: 0.15rem; color: var(--text-secondary); font-size: 0.875rem; line-height: 1.6;">
        只填写「后端主机地址」，不要加 <code>/api</code>，程序会自动拼接。<br>
        示例：
      </p>
      <ul style="margin: 0 0 0.15rem 1.1rem; padding: 0; color: var(--text-secondary); font-size: 0.82rem; line-height: 1.7;">
      ...
      <p style="margin: 0 0 1.5rem; color: var(--text-secondary); font-size: 0.78rem; line-height: 1.6;">
      ...
      />
      <div style="width: 100%; margin-top: 0.15rem; margin-bottom: 1rem; padding: 0.1rem; border: 1px solid var(--border-color); border-radius: 0.5rem; background: var(--background-tertiary); box-sizing: border-box;">
      ...
      <div style="width: 100%; margin-bottom: 1rem; padding: 0.1rem; border: 1px solid var(--border-color); border-radius: 0.5rem; background: var(--background-tertiary); box-sizing: border-box;">
        <label style="display: flex; align-items: center; cursor: pointer; width: 100%;">
      ...
      <div style="font-size: 0.75rem; color: var(--text-secondary); margin-bottom: 0.1rem; line-height: 1.5;">
